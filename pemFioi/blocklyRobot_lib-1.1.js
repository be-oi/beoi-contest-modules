      ...
      none: {
         ...
         nl: {
            label: {
               ...
               jump: "spring",
               obstacleInFront: "obstakel vooruit",
               ...
               gridEdgeEast: "rand van het raster rechts",
               gridEdgeWest: "rand van het raster links",
               gridEdgeNorth: "rand van het raster boven",
               gridEdgeSouth: "rand van het raster onder",
               platformInFront: "platform vooruit",
               platformAbove: "platform boven",
               withdrawObject: "pak het object op",
               dropObject: "laat het object vallen",
               onObject: "op een object",
               onContainer: "op een container",
               onNumber: "op een nummer",
               onWritable: "op een schoolbord",
               onLauncher: "op een laserzender",
               writeNumber: "schrijf het nummer",
               readNumber: "nummer in de cel",
               pushObject: "duw het object",
               pushableInFront: "duwbaar object vooruit",
               ...
               onMale: "naar een mannelijke stekker",
               onFemale: "naar een vrouwelijke stekker",
               dropPlatformInFront: "laat platform vooruit vallen",
               dropPlatformAbove: "laat platform boven vallen"
            },
            code: {
               row: "robotRij",
               col: "robotKolom",
               ...
               backwards: "achteruit",
               jump: "spring",
               obstacleInFront: "obstakelVooruit",
               ...
               gridEdgeEast: "rasterRandRechts",
               gridEdgeWest: "rasterRandLinks",
               gridEdgeNorth: "rasterRandBoven",
               gridEdgeSouth: "rasterRandOnder",
               platformInFront: "platformVooruit",
               platformAbove: "platformBoven",
               withdrawObject: "pakObject",
               dropObject: "laatObjectVallen",
               onObject: "opObject",
               onContainer: "opContainer",
               onNumber: "opNummer",
               onWritable: "opSchoolbord",
               onLauncher: "opLaserzender",
               writeNumber: "schrijfNummer",
               readNumber: "nummerInCel",
               pushObject: "duwObject",
               pushableInFront: "duwbaarVooruit",
               shoot: "schietLaser",
               shoot_noShadow: "schietLaser",
               shootCondition: "schietOpVoorwaarde",
               shootCondition_noShadow: "schietOpVoorwaarde",
               connect: "sluitKabelAan",
               onMale: "opMannelijkeStekker",
               onFemale: "opVrouwelijkeStekker",
               dropPlatformInFront: "laatPlatformVooruitVallen",
               dropPlatformAbove: "laatPlatformBovenVallen"
            },
            messages: {
               leavesGrid: "De robot verlaat het raster!",
               obstacle: "De robot probeert naar een obstakel te bewegen!",
               nothingToPickUp: "Er is niets om op te pakken!",
               nothingToLookAt: "Er is geen kaart of container in deze cel",
               falls: "De robot zal in de leegte springen",
               willFallAndCrash: "De robot zal van een hoog punt springen en crashen!",
               jumpOutsideGrid: "De robot probeert buiten het raster te springen!",
               jumpObstacleBlocking: "De robot probeert te springen, maar een obstakel blokkeert het",
               jumpNoPlatform: "De robot probeert te springen, maar er is geen platform boven!",
               tooManyObjects: "De robot probeert te veel objecten tegelijk te vervoeren!",
               emptyBag: "De robot probeert een object te laten vallen, maar hij draagt er geen!",
               successReachExit: "Gefeliciteerd, je robot heeft de uitgang bereikt!",
               failureReachExit: "Je robot heeft de uitgang niet bereikt.",
               successPickedAllWithdrawables: "Gefeliciteerd, je robot heeft alles opgepakt!",
               failurePickedAllWithdrawables: "Je robot heeft niet alles opgepakt.",
               successContainersFilled: "Gefeliciteerd, je robot heeft elke container gevuld",
               failureContainersFilled: "Een object is buiten de containers achtergelaten",
               failureContainersFilledLess: "Je robot heeft niet elke container gevuld",
               failureContainersFilledBag: "Je robot heeft niet alle objecten laten vallen",
               failureUnfilteredObject: "Je robot heeft een ongeldig object opgepakt",
               failureTooManyMoves: "Je robot heeft te veel bewegingen gemaakt.",
               failureWriteHere: "Je robot kan hier niet schrijven!",
               failureReadHere: "Er is hier geen nummer geschreven!",
               ...
               failureDropObject: "Je kunt hier geen platform laten vallen",
               failureDropPlatform: "Je kunt hier geen object laten vallen",
               failureDropOutside: "Je robot probeert een object buiten het raster te laten vallen",
               failureNotEnoughPlatform: "Niet genoeg platforms",
               failureLights: "Er zijn nog lampen die aan moeten.",
               successLights: "Gefeliciteerd, je robot heeft alle lampen aangezet!",
               failureLaser: "De robot moet op een laserzender staan om te kunnen schieten!",
               ...
               successPlugsWired: "De machine is gerepareerd!",
               ...
               failureWireTooLong: "Onmogelijk om deze twee stekkers te verbinden: ze zijn te ver van elkaar verwijderd!",
               failureTotalLengthExceeded: "Je hebt niet genoeg kabel om deze twee stekkers te verbinden!",
