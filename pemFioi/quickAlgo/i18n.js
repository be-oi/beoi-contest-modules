...
var localLanguageStrings = {
   ...
   de: {
      ...
      capacityWarning: "Warning : your program is invalid as it uses too many blocks. Be careful of the block limit displayed on the top right side of the editor.", // To be translated
      previousTestcase: " < ",
      nextTestcase: " > ",
   ...
   nl: {
      ...
      javascriptLanguage: "Javascript",
      importFromBlockly: "Repartir de blockly",
      loadExample: "Voorbeeld inladen",
      saveOrLoadButton: "Inladen / Bewaren",
      ...
      limitElements: "{remainingBlocks} blokken resterend van {maxBlocks} maximaal.",
      limitElementsOver: "{remainingBlocks} blokken over de limiet van {maxBlocks} maximaal.",
