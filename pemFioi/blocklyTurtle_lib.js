...
var getContext = function(display, infos) {
   var localLanguageStrings = {
      ...
      en: {
         turnleft: "right ↺",
         turnright: "left ↻",
         penup: "lift the brush",
         pendown: "lower the brush",
         categories: {
            turtle: "Turtle"
         },
         label: {
            move: "move forward",
            moveamount: "move forward by %1 steps",
            movebackamount: "move backward by %1 steps",
            moveamountvalue: "move forward by %1 steps",
            movebackamountvalue: "move backward by %1 steps",
            turnleft: "turn right ↺",
            turnright: "turn left ↻",
            turnleftamount: "turn %1° left ↺",
            turnrightamount: "turn %1° right ↻",
            turnleftamountvalue: "turn %1 left ↺",
            turnrightamountvalue: "turn %1 right ↻",
            turnleftamountvalue_noround: "turn %1 degrees left ↺",
            turnrightamountvalue_noround: "turn %1 degrees right ↻",
            turnleftamountvalue_options: "turn %1 left ↺",
            turnrightamountvalue_options: "turn %1 right ↻",
            turnleftamountvalue_moreoptions: "turn %1 left ↺",
            turnrightamountvalue_moreoptions: "turn %1 right ↻",
            turneitheramount: "turn %1° %2",
            turneitheramountvalue: "turn %1 %2",
            penup: "lift the brush",
            pendown: "lower the brush",
            peneither: "%1",
            colour2: "set color",
            colourvalue: "set color to %1",
            turn: "turn (degrees)",
            alert: "message box",
            log: "log",
         ...
         code: {
            move: "moveForward",
            moveamount: "moveForward",
            movebackamount: "moveBackward",
            moveamountvalue: "moveForward",
            movebackamountvalue: "moveBackward",
            turnleft: "turnLeft",
            turnright: "turnRight",
            turnleftamount: "left",
            ...
            turnleftamountvalue_noround: "turnLeftDegrees",
            turnrightamountvalue_noround: "turnRightDegrees",
            turnleftamountvalue_options: "turnLeftDegrees",
            turnrightamountvalue_options: "turnRightDegrees",
            turnleftamountvalue_moreoptions: "turnLeftDegrees",
            turnrightamountvalue_moreoptions: "turnRightDegrees",
         ...
         startingBlockName: "Turtle Program",
         messages: {
            paintingWrong: "The turtle did not draw everything correctly.",
            paintingCorrect: "Congratulations! The turtle drew everything correctly.",
            paintingFree: "The turtle drew the design you programmed. If you want to keep it, take a screenshot."
         }
      },
      nl: {
         turnleft: "rechts ↺",
         ...
         messages: {
            ...
            paintingFree: "De schildpad heeft de tekening gemaakt die je hebt geprogrammeerd. Als je het wilt bewaren, maak dan een screenshot."
         }
      },
      none: {
         comment: {
